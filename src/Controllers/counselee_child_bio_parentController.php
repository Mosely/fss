...
class Counselee_child_bio_parentController implements ControllerInterface
{
    ...
    public function read($request, $response, $args)
    {
        ...
        $this->container['logger']->debug("Reading counselee_child_bio_parent with id of $id");
    ...
    public function readAll($request, $response, $args)
    {
        ...
        $this->container['logger']->debug("All counselee_child_bio_parent query: ",
    ...
    public function readAllWithFilter($request, $response, $args)
    {
        ...
        try {
            Counselee_child_bio_parent::validateColumn('counselee_child_bio_parent', $filter, $this->container);
            $records = Counselee_child_bio_parent::where($filter, $value)->get();
            $this->container['logger']->debug("Counselee_child_bio_parent filter query: ",
                $this->container['db']::getQueryLog());
            if ($records->isEmpty()) {
                return $response->withJson(
                    [
    ...
    public function create($request, $response, $args)
    {
        ...
        try {
            foreach ($recordData as $key => $val) {
                Counselee_child_bio_parent::validateColumn('counselee_child_bio_parent', $key, $this->container);
            }
            $recordId = Counselee_child_bio_parent::insertGetId($recordData);
            $this->container['logger']->debug("Counselee_child_bio_parent create query: ",
                $this->container['db']::getQueryLog());
            return $response->withJson(
                [
                    "success" => true,
    ...
    public function update($request, $response, $args)
    {
        ...
        try {
            ...
            $this->container['logger']->debug("Counselee_child_bio_parent update query: ",
                $this->container['db']::getQueryLog());
            return $response->withJson(
                [
                    "success" => true,
    ...
    public function delete($request, $response, $args)
    {
        ...
        try {
            ...
            $record->delete();
            $this->container['logger']->debug("Counselee_child_bio_parent delete query: ",
                $this->container['db']::getQueryLog());
            return $response->withJson(
                [
                    "success" => true,
