...
class DrugUseController implements ControllerInterface
{
    ...
    {
        $records = DrugUse::all();
        $this->logger->debug("All DrugUse query: ",
            $this->db::getQueryLog());
    ...
    public function readAllWithFilter(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            DrugUse::validateColumn('DrugUse', $filter, $this->logger, $this->cache, $this->db);
    ...
    public function create(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            foreach ($recordData as $key => $val) {
                DrugUse::validateColumn('drug_use', $key, $this->logger, $this->cache, $this->db);
            }
