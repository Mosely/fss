 ...
 *         )
 */
class DrugUseController extends AbstractController implements 
    ControllerInterface
{
        ...
        ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        // $records = Drug_use::all();
            $encoder = Encoder::instance([
                DrugUse::class => DrugUseSchema::class,
        ...
        ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            ...
            $records = DrugUse::whereRaw('LOWER(`' . $filters[0] . '`) like ?',
                [
                    '%' . strtolower($values[0]) . '%'
                ]);
