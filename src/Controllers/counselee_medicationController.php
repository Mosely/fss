...
/**
 * The controller for counselee_medication-related actions.
 *
...
class Counselee_medicationController implements ControllerInterface
{
    ...
    public function read($request, $response, $args)
    {
        ...
        // $this->container['logger']->info("Reading counselee_medication with id of $id");
        $this->container['logger']->debug("Reading counselee_medication with id of $id");
    ...
    public function readAllWithFilter($request, $response, $args)
    {
        ...
        try {
            Counselee_medication::validateColumn('counselee_medication', $filter, $this->container);
            $records = Counselee_medication::where($filter, $value)->get();
            $this->container['logger']->debug("Counselee_medication filter query: ",
                $this->container['db']::getQueryLog());
            if ($records->isEmpty()) {
                return $response->withJson(
                    [
    ...
    public function create($request, $response, $args)
    {
        ...
        try {
            foreach ($recordData as $key => $val) {
                Counselee_medication::validateColumn('counselee_medication', $key, $this->container);
            }
            $recordId = Counselee_medication::insertGetId($recordData);
            $this->container['logger']->debug("Counselee_medication create query: ",
                $this->container['db']::getQueryLog());
            return $response->withJson(
                [
                    "success" => true,
    ...
    public function update($request, $response, $args)
    {
        ...
        try {
            ...
            $this->container['logger']->debug("Counselee_medication update query: ",
                $this->container['db']::getQueryLog());
            return $response->withJson(
                [
                    "success" => true,
    ...
    public function delete($request, $response, $args)
    {
        ...
        try {
            ...
            $record->delete();
            $this->container['logger']->debug("Counselee_medication delete query: ",
                $this->container['db']::getQueryLog());
            return $response->withJson(
                [
                    "success" => true,
