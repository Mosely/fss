...
use FSS\Schemas\CityDataSchema;
 ...
 *         )
 */
class CityDataController extends AbstractController implements 
    ControllerInterface
{
        ...
        ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        // $records = City_data::all();
            $encoder = Encoder::instance([
                CityData::class => CityDataSchema::class,
        ...
        ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            ...
            $records = CityData::whereRaw('LOWER(`' . $filters[0] . '`) like ?',
                [
                    '%' . strtolower($values[0]) . '%'
                ]);
