...
{		
	...
	public function readAll($request, $response, $args)
	{
		...
		$records = User::with(['person' => function($q) {
		...
		return $response->withJson(["success" => true, "message" => "All users returned", "data" => $records], 200, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT);
	}
	...
	public function readAllWithFilter($request, $response, $args)
	{
		...
		try {
			...
			if($records->isEmpty()){
			    return $response->withJson(["success" => true, "message" => "No users found", "data" => $records], 404);
			}
			return $response->withJson(["success" => true, "message" => "Filtered users by $filter", "data" => $records], 200, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT);
		} catch(Exception $e){
	...
	public function create($request, $response, $args)
	{
		...
		try{
			...
			return $response->withJson(["success" => true, "message" => "User $recordId has been created."], 200, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT);
		} catch(Exception $e){
			return $response->withJson(["success" => false, "message" => "Error occured: ". $e->getMessage()], 400);
		}
	}
	...
	public function update($request, $response, $args)
	{
		...
		try{
			...
			return $response->withJson(["success" => true, "message" => "Updated user $recordId"], 200, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT);
	...
	public function delete($request, $response, $args)
	{
		...
		try { 
			...
			return $response->withJson(["success" => true, "message" => "Deleted user $id"], 200, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT);
		} catch(Exception $e){
	...
	public function login($request, $response, $args)
	{
	    ...
	    try {
	        ...
	        return $response->withJson(["success" => true, "message" => "$id logged in successfully.", "id" => $id, "token" => $tokenData['token']], 200, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT);
	    } catch(Exception $e){
	        return $response->withJson(["success" => false, "message" => $e->getMessage()], 404, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT);
	    }
	}
	...
	public function logout($request, $response, $args) {
	    ...
	    try {
    	    ...
    	    return $response->withJson(["success" => true, "message" => "$userIdFromToken logged out successfully."], 200, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT);
	    } catch(Exception $e) {
	        return $response->withJson(["success" => false, "message" => $e->getMessage()], 404, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT);
	    }
	}
