...
abstract class AbstractController
{
     ...
     * pairs from the URL. $filters and $values are by
     ...
     * @throws Exception
     */
    protected function getFilters(array $params, 
        array &$filters, array &$values) {
            $filters = [];
            $values  = [];
            ...
            if (count($filters) != count($values)) {
                throw new Exception("Number of values must " . 
