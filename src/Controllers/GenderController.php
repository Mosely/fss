 ...
 *         )
 */
class GenderController extends AbstractController implements ControllerInterface
{
        ...
        ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        // $records = Gender::all();
            $encoder = Encoder::instance([
                Gender::class => GenderSchema::class,
        ...
        ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            ...
            $records = Gender::whereRaw('LOWER(`' . $filters[0] . '`) like ?',
                [
                    '%' . strtolower($values[0]) . '%'
                ]);
