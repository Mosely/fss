...
class GenderController implements ControllerInterface
{
    ...
    {
        $records = Gender::all();
        $this->logger->debug("All genders query: ",
            $this->db::getQueryLog());
        // $records = Gender::all();
    ...
    public function readAllWithFilter(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            Gender::validateColumn('gender', $filter, $this->logger, $this->cache, $this->db);
    ...
    public function create(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            foreach ($recordData as $key => $val) {
                Gender::validateColumn('gender', $key, $this->logger, $this->cache, $this->db);
            }
