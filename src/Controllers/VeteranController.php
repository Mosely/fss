...
class VeteranController implements ControllerInterface
{
    ...
    {
        $records = Veteran::all();
        $this->logger->debug("All Veteran query: ",
            $this->db::getQueryLog());
        // $records = Veteran::all();
    ...
    public function readAllWithFilter(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            Veteran::validateColumn('veteran', $filter, $this->logger, $this->cache, $this->db);
    ...
    public function create(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            foreach ($recordData as $key => $val) {
                Veteran::validateColumn('veteran', $key, $this->logger, $this->cache, $this->db);
            }
