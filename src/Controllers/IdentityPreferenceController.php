...
use FSS\Schemas\IdentityPreferenceSchema;
 ...
 *         )
 */
class IdentityPreferenceController extends AbstractController implements 
    ControllerInterface
{
        ...
        ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        // $records = Identity_preference::all();
            $encoder = Encoder::instance([
                IdentityPreference::class => IdentityPreferenceSchema::class,
        ...
        ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            ...
            $records = IdentityPreference::whereRaw(
