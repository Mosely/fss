...
use FSS\Schemas\ShelterClientFundingSourceSchema;
 ...
 *         )
 */
class ShelterClientFundingSourceController extends AbstractController implements 
    ControllerInterface
{
        ...
        ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        // $records = Shelter_client_funding_source::all();
            $encoder = Encoder::instance([
                ShelterClientFundingSource::class => ShelterClientFundingSourceSchema::class,
        ...
        ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            ...
            foreach ($filters as $filter) {
                ShelterClientFundingSource::validateColumn($filter,
