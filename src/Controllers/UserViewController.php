...
class UserViewController implements ControllerInterface
{
    ...
    public function readAll(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        $this->logger->debug("All UserView query: ",
            $this->db::getQueryLog());
    ...
    public function readAllWithFilter(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            UserView::validateColumn('UserView', $filter, $this->logger, $this->cache, $this->db);
    ...
    public function create(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            foreach ($recordData as $key => $val) {
                UserView::validateColumn('UserView', $key, $this->logger, $this->cache, $this->db);
            }
    ...
    public function delete(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            ...
            $record->delete();
            $this->logger->debug("UserView delete query: ",
                $this->db::getQueryLog());
            return $response->withJson(
                [
                    "success" => true,
