...
use FSS\Schemas\CounseleeChildSiblingSchema;
 ...
 *         )
 */
class CounseleeChildSiblingController extends AbstractController implements 
    ControllerInterface
{
        ...
        ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        // $records = CounseleeChildSibling::all();
            $encoder = Encoder::instance([
                CounseleeChildSibling::class => CounseleeChildSiblingSchema::class,
